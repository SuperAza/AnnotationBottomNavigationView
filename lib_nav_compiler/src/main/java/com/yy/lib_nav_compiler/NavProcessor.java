package com.yy.lib_nav_compiler;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.google.auto.service.AutoService;
import com.yy.lib_navigation.ActivityDestination;
...
/**
 * 作者：addison on 2020-02-18 13:35
 * 邮箱：gengxin@tech.youyuan.com
 */

@AutoService(Processor.class)
@SupportedSourceVersion(SourceVersion.RELEASE_8)
@SupportedAnnotationTypes({"com.yy.lib_navigation.ActivityDestination","com.yy.lib_navigation.FragmentDestination"})
public class NavProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        ...
        if (!fragmentElements.isEmpty() || !activityElements.isEmpty()) {
            ...
            // 我们要写入的路径是//app/src/main/assets，作为lib没有办法获取到这个路径，一下是另辟蹊径方式
            ...
            try {
                ...
                //以此便能准确获取项目的 /app/src/main/assets/的路径
